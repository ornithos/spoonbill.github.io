...
![alt text](https://github.com/spoonbill/spoonbill.github.io/blob/master/images/clusters2.png "fake dataset - superimposed clusters"| width = 100) ![alt text](https://github.com/spoonbill/spoonbill.github.io/blob/master/images/clusters1.png "fake dataset - as seen by the algorithm."|width=100)
